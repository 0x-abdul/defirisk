...
const EXPLOITS: LearnTopic[] = [
  ...
  },
  {
    ...
    slug: 'logic-error',
    title: 'Logic Errors',
    description: 'How incorrect business logic — rounding, state transitions, or arithmetic mistakes — creates exploitable discrepancies.',
  ...
  },
  {
    ...
    body: [
      'Cross-chain bridges hold some of the largest concentrations of value in DeFi and have been the single most targeted category by high-value attackers. Bridges rely on off-chain validators or on-chain proof systems to attest that an asset was locked on chain A before minting it on chain B. Any flaw in this attestation mechanism allows minting without locking — effectively unlimited counterfeit assets.',
...
const FACTORS: LearnTopic[] = [
  ...
  },
  {
    ...
    description: 'Why deploying unverified contracts — no public ABI, no Etherscan source — is a ★ critical risk signal.',
    factorId: 'RD-F-046',
    body: [
